...
let picArray = ['ba687af4-3a1e-43d7-87b2-f30453264c9d_mountains.jpeg','8aa075b0-67cf-47ce-9a7f-8cc9d754675d_computer.jpeg','5b7441c6-6e4b-4feb-a4ec-8dd2eb76238a_trees.jpeg']
picArray.forEach(name=>{
  axios.get(`https://tk-assets.lambdaschool.com/${name}`)
  .then(res =>{
    const profile = carouselMaker(res.data)
