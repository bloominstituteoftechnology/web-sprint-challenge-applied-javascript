...
1. What is the DOM? Document Object Model. It defines structure of the document and how it can be accessed and manipulated.

2. What is an event? Event are the the "things" that happen to the HTML elements.

3. What is an event listener? An event listner is a trigger produced in javascript that waits for an event to occur. Example of this is tying an event listner to clicking the mosue our pressing a key on the keyboard.

4. Why would we convert a NodeList into an Array? So that is easier to manipulate in the DOM.

5. What is a component? Components are independent and reusable bits of code. They serve the same purpose as functions but work independently and return HTML wia the rendered function.
