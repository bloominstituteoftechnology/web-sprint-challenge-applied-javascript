...
1. What is the DOM?
Bridge between js and content
2. What is an event?
any movement or action on the browser
3. What is an event listener?
listener does something when a certain event happens
4. Why would we convert a NodeList into an Array?
to be able to iterate over it
5. What is a component?
a precoded piece of code that can be reused to make many
