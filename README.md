...
3. What is an event listener?
   Event listeners represents an object that can handle an event dispatched by an EventTarget object.

4. Why would we convert a NodeList into an Array?
   If we wanted to do anything with the node list we wouldnt be able to use advance array methods to itterate.

5. What is a component?
   Componets make life and code easier. they are parts tthat u make so you dont have to write repeated cluttered code.Components are independent and reusable bits of code.
