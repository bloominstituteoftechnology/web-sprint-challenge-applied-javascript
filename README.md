...
1. What is the DOM?
document object model / is a programming API for HTML and XML/ logical structure for manupulation and acess point

2. What is an event?
javascripts response (interaction) with HTML to a event handler
HTML events are "things" that happen to HTML elements.
When JavaScript is used in HTML pages, JavaScript can "react" on these events.

3. What is an event listener?
is a procedure or function in a computer program that waits for an event to occur. ... The listener is programmed to react to an input or signal by calling the event's handler

4. Why would we convert a NodeList into an Array?
easier to select a item with particular class

5. What is a component?
independent and reusable bits of code/ returns HTML via a render function
