...
1. What is the DOM?
    ...
    It is the API for HTML document. It shows the structure of the document and the way a document is accessed and manipulated. DOM is an achronym for Document OBject Model.

2. What is an event?

    An event can be a click, a mouseover, a keypress, ect that will trigger script to manipulate a future event

3. What is an event listener?

    This is the script triggered by an event.

4. Why would we convert a NodeList into an Array?

    Arr are beneficias due to the defined length, and assigned items to refference. 

5. What is a component?

    A component are stand alone reusable bits of code. 
