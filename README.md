...
1. What is the DOM?
The Document Object Model is a programming interface for HTML and XML documents and it represents the page in a tree like manner allowing programs and programmers to edit the page.
2. What is an event?
A event is everything from when the page loads, to the user clicking, buttons being pressed, resizing or closing a window etc.
3. What is an event listener?
A event listener is a function which listens for a specified event and performs a secondary arguement when the event occurs.
4. Why would we convert a NodeList into an Array?
Converting Nodelists into arrays would be useful, due to the fact array methods could then be used, I.e. array.filter, array.forEach.
5. What is a component?
Components are standalone reusable sections of code, kind of like a constructor.
