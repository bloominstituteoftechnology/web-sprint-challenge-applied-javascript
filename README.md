...
1. What is the DOM? 
    -Document object model; it is a built data strutcure much like a tree. Elements are nested and branches can be followed.

2. What is an event?
    -events are user interatctions with the site, such as clicks

3. What is an event listener?
    -an event listener is a method that takes two arguements, the event to listen for and a callback which fires when the event is triggered

4. Why would we convert a NodeList into an Array?
    -Node list is API information, so array methods will not work. Converting to an array allows for the use array methods, such as .forEach or .map.

5. What is a component?
    -A component is comprised of many things; HTML, CSS, and JavaScript. These come together to be reused on a website.
