const Tabs = (topics) => {
  ...
  const sibOne = document.createElement("div");
  const sibTwo = document.createElement("div");
  const sibThree = document.createElement("div");
  ...
  sibOne.classList.add("tab");
  sibTwo.classList.add("tab");
  sibThree.classList.add("tab");
